...
## Обновление кэша в Telegram Mini App

Telegram кэширует Mini App, поэтому изменения могут не отображаться сразу. Вот способы обновить:

### Способ 1: Перезапуск Mini App
...
4. Перезапустите Mini App

### Способ 3: Добавление версии в URL (для разработки)
Добавьте параметр версии в URL при настройке бота:
```
https://your-url.ngrok-free.app?v=1
```
При каждом изменении увеличивайте версию:
```
https://your-url.ngrok-free.app?v=2
```

### Способ 4: Использование WebApp.reload() в коде
Добавьте в код для принудительной перезагрузки:
```javascript
...
### Способ 5: Открытие в браузере
1. Скопируйте URL из ngrok
2. Откройте его в браузере (Chrome/Safari)
3. Изменения будут видны сразу
...
5. **Кэширование**: Telegram агрессивно кэширует Mini Apps, используйте версионирование URL
